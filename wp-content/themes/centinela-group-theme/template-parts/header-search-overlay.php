...
<div id="centinela-search-overlay" class="centinela-search-overlay" aria-hidden="true" hidden>
	<div class="centinela-search-overlay__inner">
		<div class="centinela-search-overlay__form-wrap">
			<form role="search" method="get" class="centinela-search-overlay__form" action="<?php echo esc_url( home_url( '/' ) ); ?>" id="centinela-search-form" accept-charset="<?php echo esc_attr( get_bloginfo( 'charset' ) ); ?>">
				<label for="centinela-search-field" class="screen-reader-text"><?php esc_html_e( 'Buscar', 'centinela-group-theme' ); ?></label>
				<input type="search" id="centinela-search-field" class="centinela-search-overlay__input" placeholder="<?php esc_attr_e( 'Buscar por nombre, referencia, marca o contenido…', 'centinela-group-theme' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" autocomplete="off" />
			...
			<div id="centinela-search-suggestions" class="centinela-search-overlay__suggestions" aria-live="polite" hidden></div>
		</div>
