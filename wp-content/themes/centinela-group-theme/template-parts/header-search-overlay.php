	...
	<div class="centinela-search-overlay__inner">
		<div class="centinela-search-overlay__form-wrap">
			<form role="search" method="get" class="centinela-search-overlay__form" action="<?php echo esc_url( home_url( '/' ) ); ?>" id="centinela-search-form">
				...
				<input type="search" id="centinela-search-field" class="centinela-search-overlay__input" placeholder="<?php esc_attr_e( 'Buscar contenido o productos (ej. nombre o referencia)…', 'centinela-group-theme' ); ?>" value="<?php echo get_search_query(); ?>" name="s" autocomplete="off" />
